...
handleListEventVi fallback e theList =
    case e of
        ...
        EvKey (KChar 'd') [MCtrl] -> listMoveByPages ( 0.5 :: Rational) theList
        EvKey (KChar 'u') [MCtrl] -> listMoveByPages (-0.5 :: Rational) theList
...
listMovePageUp theList = listMoveByPages (-1 :: Rational) theList
...
listMovePageDown theList = listMoveByPages (1 :: Rational) theList
